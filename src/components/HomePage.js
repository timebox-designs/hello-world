                ...
                <section>
                    <Grid>
                        ...
                        <p className="lead">
                            ...
                            selecting and researching a brand, creating a strategy, some mock copy, and a quick sketch
                            for various on and offline mediums.
                        </p>
                        ...
                        <Row>
                            ...
                            <Col md={6} lg={4}>
                                <Thumbnail className="img-top" src={ticTacs} alt="Tic Tacs">
                                    ...
                                    <Link to="tic-tacs">More</Link>
                                </Thumbnail>
                            </Col>

                            <Col md={12} lg={8}>
                                <blockquote className="blockquote blockquote-reverse" style={marginTop}>
                                    <p>
                ...
                <section className="puff-piece color-section green-hue">
                    <Grid>
                        <div className="puff-piece-image">
                            <Image src={sarah} className="green-hue" circle responsive/>
                        </div>
                        ...
                        <Row>
                            <Col sm={12}>
                                <blockquote className="blockquote blockquote-reverse" style={ darkenBorder }>
                                    <p>
                                        I am an insatiable coffee drinker and travel lover, who has fallen in love with
                                        the process of coming up with ideas. Writing, developing and creating are my
                                        life, extreme organization is just my fun quirk.
                                    </p>
                                    <footer className="blockquote-footer">
